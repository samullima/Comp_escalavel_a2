...
int main() {
    ...
    // DF transactions
    vector<string> colName__t = {"transaction_id", "account_id", "amount", "location"};
    vector<string> colType__t = {"int", "int", "float", "string"};
    DataFrame df_6(colName__t, colType__t);

    // DF account
    vector<string> colName__a = {"account_id", "location"};
    ...
    DataFrame df_abnormal = abnormal_transactions(df_6, df_7, "transaction_id", "amount", "location", "account_id", "account_id", "location", pool);
    df_abnormal.printDF();
